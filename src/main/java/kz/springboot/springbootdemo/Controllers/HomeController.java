...
//    @PreAuthorize("hasAnyRole('ROLE_USER','ROLE_ADMIN','ROLE_MODERATOR')")
    public String shoppers(Model model, HttpServletRequest request){

        List<Categories> categories = itemService.getAllCategories();
        Optional<Categories> categoriesFilter = categories.stream().filter(r -> r.getName().equals("shoppers")).findFirst();
        List<Items> items = itemService.getAllItemsByCategories(categoriesFilter.get());
    ...
    @GetMapping(value = "/posters")
//    @PreAuthorize("hasAnyRole('ROLE_USER','ROLE_ADMIN','ROLE_MODERATOR')")
    public String posters(Model model, HttpServletRequest request){

        List<Categories> categories = itemService.getAllCategories();
        Optional<Categories> categoriesFilter = categories.stream().filter(r -> r.getName().equals("posters")).findFirst();
        List<Items> items = itemService.getAllItemsByCategories(categoriesFilter.get());
...
//    @PreAuthorize("hasAnyRole('ROLE_USER','ROLE_ADMIN','ROLE_MODERATOR')")
    public String postcard(Model model, HttpServletRequest request){

        List<Categories> categories = itemService.getAllCategories();
        Optional<Categories> categoriesFilter = categories.stream().filter(r -> r.getName().equals("postcard")).findFirst();
        List<Items> items = itemService.getAllItemsByCategories(categoriesFilter.get());
...
//    @PreAuthorize("hasAnyRole('ROLE_USER','ROLE_ADMIN','ROLE_MODERATOR')")
    public String hoodie(Model model, HttpServletRequest request){

        List<Categories> categories = itemService.getAllCategories();
        Optional<Categories> categoriesFilter = categories.stream().filter(r -> r.getName().equals("hoodie")).findFirst();
        List<Items> items = itemService.getAllItemsByCategories(categoriesFilter.get());
...
//    @PreAuthorize("hasAnyRole('ROLE_USER','ROLE_ADMIN','ROLE_MODERATOR')")
    public String cases(Model model, HttpServletRequest request){
        ...
        List<Categories> categories = itemService.getAllCategories();
        Optional<Categories> categoriesFilter = categories.stream().filter(r -> r.getName().equals("cases")).findFirst();
        List<Items> items = itemService.getAllItemsByCategories(categoriesFilter.get());
...
//    @PreAuthorize("hasAnyRole('ROLE_USER','ROLE_ADMIN','ROLE_MODERATOR')")
    public String tshirts(Model model,HttpServletRequest request){
        ...
        List<Categories> categories = itemService.getAllCategories();
        Optional<Categories> categoriesFilter = categories.stream().filter(r -> r.getName().equals("tshirts")).findFirst();
        List<Items> items = itemService.getAllItemsByCategories(categoriesFilter.get());
